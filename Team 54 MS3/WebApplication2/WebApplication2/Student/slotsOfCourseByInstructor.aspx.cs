...
{
    public partial class slotsOfCourseByInstructor : System.Web.UI.Page
    {
        ...
        private void PopulateInstructorsDropDown(int course_id)
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["Advising_Team_54"].ToString();
