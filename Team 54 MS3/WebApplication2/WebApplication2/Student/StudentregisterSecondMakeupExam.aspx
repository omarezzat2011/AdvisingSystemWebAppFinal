<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentregisterSecondMakeupExam.aspx.cs" Inherits="WebApplication2.StudentregisterSecondMakeupExam" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Label2">
            Student Register 2nd Makeup Exam
        </div>
        ...
        <div class="form-group">
            <asp:Button ID="IdRegisterSecondMakeup" runat="server" CssClass="custom-button" Text="Register Second Makeup" OnClick="btnRegisterSecondMakeup_Click" />
        </div>
